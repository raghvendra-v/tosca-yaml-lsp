...
@DisplayName("ETSI catalogue Parse Test")
class ETSI_BulkParserTest {
	@Inject
	ParseHelper<YamlDocument> parseHelper

	static	String[] configFilePaths = #["C:/Users/607058220/Downloads/Definitions"];
	...
	def static List<Arguments> getFiles() {
		...
		configFilePaths.filter[p | (new File(p)).exists ].forEach [ configFilePath |
